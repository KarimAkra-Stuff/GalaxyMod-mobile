...
class FlxVideo extends Video
{
	...
	{
		if (autoResizeMode == FlxAxes.X || autoResizeMode == FlxAxes.Y)
		{
			width = autoResizeMode == FlxAxes.X ? FlxG.scaleMode.gameSize.x : formatWidth;
			height = autoResizeMode == FlxAxes.Y ? FlxG.scaleMode.gameSize.y : formatHeight;
		}
