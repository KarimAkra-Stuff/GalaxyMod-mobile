...
class TouchPad extends FlxSpriteGroup
{
	...
	public var buttonLeft2:TouchButton = new TouchButton(0, 0);
	public var buttonUp2:TouchButton = new TouchButton(0, 0);
	public var buttonRight2:TouchButton = new TouchButton(0, 0);
	public var buttonDown2:TouchButton = new TouchButton(0, 0);
	...
	private function createButton(X:Float, Y:Float, Graphic:String, Color:Int = 0xFFFFFF):TouchButton
	{
		...
		try {
            ...
            #if android
            Toast.makeText("Failed to create button(s) " + e.message, Toast.LENGTH_SHORT);
            #end
