...
class MobileControlsSubState extends FlxSubState
{
	...
	private var virtualPad:TouchPad;
	...
	private var bindButton:TouchButton;
	...
	override function create()
	{
		...
		var exitButton:FlxButton = new FlxButton(FlxG.width - 200, 50, 'Exit & Save', function()
		{
		...
		exitButton.x = FlxG.width - exitButton.width - 70;
		...
		resetButton = new FlxButton(exitButton.x, exitButton.y + 100, 'Reset', function()
		{
			...
			{
				MobileControls.customVirtualPad = new TouchPad(RIGHT_FULL, NONE);
		...
		funitext = new FlxText(0, 0, 0, 'No Controls!', 32);
	...
	private function moveButton(touch:FlxTouch, button:TouchButton):Void
	{
		bindButton = button;
