 ...
 */
class TouchButton extends TypedTouchButton<FlxText>
{
	/**
	...
	/**
	 * Creates a new `TouchButton` object with a gray background
...
class TypedTouchButton<T:FlxSprite> extends FlxSprite implements IFlxInput
{
	...
	/**
	 * Creates a new `TypedTouchButton` object with a gray background.
	 *
	 * @param   X         The x position of the button.
	 * @param   Y         The y position of the button.
	 * @param   OnClick   The function to call whenever the button is clicked.
